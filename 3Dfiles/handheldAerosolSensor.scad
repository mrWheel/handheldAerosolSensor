...
//-  0,   1,         2,       3, 4, 5,       6, 7,       8, -rest-
    [3.5, 3.5, default, default, 4, 2, default, 4, default, yappFrontLeft, yappFrontRight, yappCoordPCB]
];
...
[
//  0     1   2  3  4          5      6
  //[63, -10, 14.5, 8, 1, yappRoundedRect, 20, yappCenter, yappCoordPCB], //-- USB.
//  0,   1,  2,  3, 4,               5,  6, --rest--
  [69, 23, 15, 12, 2, yappRoundedRect, yappCenter, yappCoordBox] //-- USB charge port
];
...
//translate([69.5,1,-20]) color("red") rotate([0,0,0]) cube ([1,1,80]);
//translate([-10,shellWidth/2,100]) color("red") rotate([0,90,0]) cube ([1,1,200]);